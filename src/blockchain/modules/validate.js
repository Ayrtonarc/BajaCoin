...
export default (blockchain) => {
    ...
    if(JSON.stringify(genesisBlock) !== JSON.stringify(Block.genesis)) throw Error('Invalid Genesis block');   //devuelve una copia exacta cuando se usa el JSON

    for (let i = 0; i < blocks.length; 1 +- 1){
        const {
